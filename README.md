...
The data used to create the algorithm comes from recording using a microcontroller, Mikromedia 4 for STM32F4 from https://mikroe.com with input signals from 
